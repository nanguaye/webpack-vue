...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Favlist = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/nangua/Documents/my/webpack-test01/app/index/components/Favlist.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _demoJS = __webpack_require__(74);
	...
	exports.default = {
	  data: function data() {
	    return {
	      a: '哈哈',
	      b: 'ca',
	      c: _demoJS2.default.a
	    };
	  },
	  ready: function ready() {
	    this.demo2(1).then(function (val1) {
	      return val1;
	    }).then(function (val2) {
	      val2('ych').then(function (v) {
	        console.log('v', v);
	      });
	    });
	  },
	  ...
	  methods: {
	    demo1: function demo1(name) {
	      return new _promise2.default(function (rev, rec) {
	        if (name === 'ych') {
	          rev('成功了!!');
	        }
	      });
	    },
	    demo2: function demo2(num) {
	      var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "resources/icon-shop.46a918a5.png";
